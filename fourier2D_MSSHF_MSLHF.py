...
torch.save(net.state_dict(), path_outputs+'DTAS_BNN_FNO2D_PECstep_MSSHF_MSLHF_ocean_spectral_loss_modes_'+str(modes)+'_wavenum'+str(wavenum_init)+'lead'+str(lead)+'.pt')
